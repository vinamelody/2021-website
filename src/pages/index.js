  ...
  return (
    <Layout>
      ...
      <section className="text-center bg-gray-100 py-24">
        ...
        <p className="mb-12">
          <a href="https://www.papercall.io/iosconfsg2021" className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 border-gray-400 rounded shadow">Download Sponsorship Deck</a>
        </p>
      </section>
    </Layout>
  );
