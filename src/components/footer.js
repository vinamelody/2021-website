        ...
        <section className="bg-orange-600">
            <div className="max-w-4xl mx-auto text-white text-left text-center">
                <ul className="list-none my-4">
                    <li className="inline-block mr-4"><Link to="https://www.facebook.com/iosconfsg/"><FontAwesomeIcon size="2x" icon={faFacebookF} /></Link></li>
                    <li className="inline-block mr-4"><Link to="https://www.twitter.com/iosconfsg/"><FontAwesomeIcon size="2x" icon={faTwitter} /></Link></li>
                    <li className="inline-block mr-4"><Link to="https://launchpass.com/iosconfsg"><FontAwesomeIcon size="2x" icon={faSlackHash} /></Link></li>
                </ul>
            </div>
        </section>
